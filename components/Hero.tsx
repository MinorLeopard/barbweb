...
<link href="https://fonts.googleapis.com/css2?family=Ubuntu:wght@300&display=swap" rel="stylesheet"></link>
    ...
    <p className="absolute p-10 pt-6 text-2xl text-white">Available now on playstore serving a large number of salons providing ease of booking with a review and rating system</p>
