...
const Hero = () => {
  return (
    <div>
    <div className="flex flex-col items-center justify-center w-full max-w-full py-5 bg-gray-200 lg:mb-0 min-w-max">
      <div className="flex flex-col items-center justify-start w-full max-w-full py-5 bg-gray-200 lg:mb-0 min-w-max md:space-x-28 md:justify-evenly md:items-start md:flex-row">
