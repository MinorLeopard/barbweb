...
<div className="flex items-center justify-center w-full h-screen bg-pink-400 rounded">
        <div className="grid h-full grid-cols-1 text-sm text-center bg-white rounded-sm shadow-2xl md:grid-cols-2 xl:w-4/5 md:w-full md:h-4/5 w-96">
            <div className="">
            ...
            <div className="flex items-center justify-center w-full h-full px-3 text-center text-white bg-my-color">
                <div className="h-full px-8 text-gray-100 lg:text-lg">
                    <img className="w-24 h-24 mx-auto md:w-36 md:h-36"
                        src="https://cdn.dribbble.com/users/1522534/avatars/normal/767dc6a0a6f991d3d3e0d3fc378c2bcf.jpg"
                        alt="">
                    <div className="mb-2 font-sans md:mb-3">
                        <h2 className="font-medium uppercase">OUR STORY</h2>
                    </div>
                    ...
                    <p className="mt-5 mb-5 text-sm md:mb-10 lg:text-md">

Our company began in Patna, Bihar as a small startup covering 47 salons in Patna, providing them with the opportunity to digitize themselves. We created a platform for the common man to pick what he wants in his next appointment at a salon

We are trying to revolutionize the salon industry and make user experience easy while improving the lifestyle of the people.

                    </p>
                    <a className="px-8 py-2 font-medium text-center transition-all duration-150 bg-green-400 rounded-full hover:bg-green-500 md:px-12 sm:px-10 sm:py-3 md:text-xl text-md text-my-color"
                        href="https://dribbble.com/shots/3377897-UI-Avatar?utm_source=Clipboard_Shot&utm_campaign=EleanaGkogka&utm_content=UI%20Avatar&utm_medium=Social_Share&utm_source=Clipboard_Shot&utm_campaign=EleanaGkogka&utm_content=UI%20Avatar&utm_medium=Social_Share">
                        View portfolio
                    </a>
                </div>
            </div>
