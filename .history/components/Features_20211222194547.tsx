...
<h2 className="mt-16 mb-10 font-normal text-gray-800 text-7xl md:text-6xl">WHY<span className="font-extrabold text-gray-500"><BARB></BARB></span></h2>
        ...
        <div className="flex flex-col items-center w-full px-10 lg:flex-row justify-evenly ">
          ...
          <div className="flex flex-col items-start ml-5 text-left xl:ml-10">
            ...
            <p className="w-[400px] text-white items-center pt-10">
              ...
              et at diam erat takimata, elitr aliquyam accusam clita elitr justo
              lorem, invidunt lorem ipsum duo accusam, sit amet dolore
              consetetur sed takimata sea amet. Nonumy kasd ut at takimata
              gubergren diam. Ipsum invidunt amet consetetur eirmod ipsum.
              Dolores.
            </p>
          </div>
        </div>
