...
const Hero = () => {
  return (
    ...
    <p className="absolute p-4 mt-10 text-xs text-white md:pl-8">GAvailable now on playstore serving a large number of salons providing ease of booking with a review and rating system</p>
